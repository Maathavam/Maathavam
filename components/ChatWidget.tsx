          ...
          >
            ...
            >
              <input
                ...
                disabled={loading}
                className="flex-1 bg-cream rounded-xl px-3 py-2 text-base font-body text-ink focus:outline-none focus:ring-2 focus:ring-gold/50 disabled:opacity-60 placeholder:text-ink-light/60"
              />
              <motion.button
                type="submit"
